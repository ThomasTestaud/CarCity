class Car {
    ...
    lights() {
        ...
        document.querySelectorAll('.headlight')[0].classList.toggle('headlight-on');
        setTimeout(function() {
            document.querySelectorAll('.headlight')[1].classList.toggle('headlight-on');
        }, 200);
        setTimeout(function() {
            document.querySelectorAll('.rearlight')[1].classList.toggle('rearlight-on');
        }, 100);
        setTimeout(function() {
            document.querySelectorAll('.rearlight')[0].classList.toggle('rearlight-on');
        }, 250);
    }
